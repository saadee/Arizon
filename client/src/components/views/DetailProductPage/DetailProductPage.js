...
function DetailProductPage({
  ...
  return !product.images ? (
    ...
    <div
      className="productDetailWrapperDiv"
        ...
        >
          ...
          >
            <div>
              <Card
                ...
                style={{ width: "80%", margin: "1rem auto", height: "70%" }}
                hoverable={true}
          ...
          >
            <div>
              <Card
                className="productImageDiv"
                style={{ width: "80%", margin: "0.2rem auto" }}
                xs={24}
                lg={12}
                md={16}
                sm={24}
          ...
          <div className="item_pricing_details">
            ...
            <div>
              ...
              <div className="items" style={{ margin: "10px" }}>
                ...
                <Button className="btn-3" onClick={(e) => add(e)}>
                  +
                </Button>
              </div>
                        ...
                        <img
                          ...
                          src={
                            product.category == "Mens"
                              ? menChart
                              : womenChart || product.category == "women"
                              ? womenChart
              ...
              <button className="addCart-btn" onClick={(e) => addTocartItem(e)}>
                Add To Cart
              </button>
              <button
