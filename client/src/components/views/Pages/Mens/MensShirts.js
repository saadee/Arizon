...
import { getMensShirts } from "../../../../_actions/product_action";
...
const MensShirtsPage = ({ product: { MensShirts, loading, Skip, Limit, postSize }, getMensShirts }) => {
  ...
  const updateSearchItems = (newSearchItems) => {
    ...
    console.log("products", MensShirts)
    const filtereditem = MensShirts.filter((p) =>
...
MensShirtsPage.propTypes = {
  getMensShirts: PropTypes.func.isRequired,
  MensShirts: PropTypes.array.isRequired,
...
export default connect(mapStateToProps, { getMensShirts })(MensShirtsPage);
